...
@if (session()->has('delete'))
    <script>
        window.onload = function() {
            notif({
                msg: " تم حذف بيانات المستخدم بنجاح",
                type: "success"
            });
        }
    </script>
        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="col-sm-1 col-md-2">
                    @can('اضافة مستخدم')
                        <a class="btn btn-primary btn-sm" href="{{ route('create_user') }}">اضافة مستخدم</a>
                    @endcan
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($data as $user)
                                <tr>
                                    ...
                                    <td>
                                        @can('تعديل مستخدم')
                                            <a href="{{ route('edit_user', $user->id) }}" class="btn btn-sm btn-info"
