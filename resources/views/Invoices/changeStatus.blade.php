...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('updateStatus', $invoice->id) }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        @method('put')
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select id="sectionName" name="Section" class="form-control SlectBox"
                            ...
                            <div class="col">
                                ...
                                <select id="productName" name="product" class="form-control SlectBox">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="{{ $invoice->Rate_Vat }}" selected disabled>{{ $invoice->Rate_Vat }}
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="note" rows="3"
                                    placeholder="{{ $invoice->note }}" readonly></textarea>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" name="status" id="status" required>
                                    <option selected disabled>--اختر حالة الدفع--</option>
                            ...
                            <div class="col">
                                ...
                                <br>
                                <input class="form-control" type="date" name="payDate" id="date" required>
                            </div>
                        </div>
